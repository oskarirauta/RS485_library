...
int main() {
  ...
  while ( rounds++ < MAXROUNDS ) {
	...
	sprintf((char *)fileCMD, "ATINFILE,10,1,%d", fsize);

      	if ( !rs485.sendFile(fileCMD, (char *)"./README.txt") )
          printf("Was not able to send Readme file.\r\n");
      	else
          printf("Sent file: README.txt\r\n");
